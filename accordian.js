...
function initStandardAccordions(accordionButtons) {
  ...
  const faqAnswers = {
    "How is Fedena different from other school management software?": 
      `<p class="text-gray-600 text-sm leading-relaxed">Fedena stands out with its 100+ integrated modules, mobile apps, and 24/7 support system. Unlike other systems, it offers a user-friendly interface, is compatible with all education boards, and provides comprehensive features from student management to financial reporting.</p>`,
    
    "What kind of software programs do I require to run Fedena?": 
      `<p class="text-gray-600 text-sm leading-relaxed">Fedena is a web-based application that only requires a modern web browser like Chrome, Firefox, or Edge. No additional software installation is needed as it runs entirely in the cloud.</p>`,
    
    "Can Fedena ERP software be customized for my Institute?": 
      `<p class="text-gray-600 text-sm leading-relaxed">Yes, Fedena can be fully customized to meet the specific requirements of your institution. We offer tailored solutions for different educational boards and institute types.</p>`,
    
    "Does Fedena provide data backup facility?": 
      `<p class="text-gray-600 text-sm leading-relaxed">Yes, Fedena provides automated daily backups with enterprise-grade security. Your data is safely stored with redundancy to prevent any loss.</p>`,
    
    "What measures do we take for data security?": 
      `<p class="text-gray-600 text-sm leading-relaxed">Fedena implements bank-grade security measures including encryption, secure data centers, regular security audits, and GDPR compliance to ensure your institution's data remains protected.</p>`,
  ...
  accordionButtons.forEach((button) => {
    ...
    if (contentDiv && (!contentDiv.querySelector('.p-6') || contentDiv.querySelector('.p-6').innerHTML.trim() === '')) {
