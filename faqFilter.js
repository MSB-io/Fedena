...
document.addEventListener("DOMContentLoaded", function() {
    ...
    categoryButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const categoryMap = {
                'features': ['How is Fedena different', 'Can Fedena ERP software be customized', 'Does Fedena provide GPS tracking'],
                'technical': ['What kind of software programs', 'Does Fedena provide data backup', 'Does Fedena Support third party plugins'],
                'pricing': ['How much does Fedena cost', 'Will I be bound to any long-term contract', 'Can I switch from one package to another'],
                'support': ['Does Fedena offer support and training', 'What happens to the information', 'Can I try Fedena before buying it']
            };
